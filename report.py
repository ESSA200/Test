...
MAX_EMAILS = 6
TOKEN = '6552878954:AAENDHlcjr9ctlXyPSeAZg-ldZjZ0a2PeXw'
...
def send_welcome(message):
    users = load_users()
    if str(message.from_user.id) in users or message.from_user.id == 6528813178:
    ...
    else:bot.send_message(message.chat.id, "عذراًلم تقم بالاشتراك بالبوت! ، للاشتراك تواصل مع ")
...
def handle_id(message):
    if message.from_user.id == 6528813178:
